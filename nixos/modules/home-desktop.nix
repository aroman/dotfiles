...
in
{
  ...
  # Desktop-only configuration symlinks.
  xdg.configFile = {
  ...
  # The base module inserts these GUI-only segments into its single
  # default-priority package definition, retaining the historical order.
  _module.args.desktopPackageSegments = with pkgs; {
    afterRcm = [
      handlr-regex
    ];
    afterFzf = [
