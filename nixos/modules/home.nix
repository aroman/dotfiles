...
in
{
  ...
  home.file = {
    ...
    ".rcrc".text = ''
      ...
      EXCLUDES="Brewfile config gemrc gitconfig gitignore_global hooks hushlogin iTerm2 Library nixos PLAN.md README.md rules.velja-rules ssh vim xterm-256color-italic.terminfo zshrc"
    '';
  };
