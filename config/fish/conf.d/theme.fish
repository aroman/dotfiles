...
set -x FZF_DEFAULT_OPTS \
    --cycle --layout=reverse --border=none --height=90% --preview-window=wrap --list-border=right --preview-border=left --marker='*' --scrollbar='█' --input-border --no-separator --info=inline-right \
